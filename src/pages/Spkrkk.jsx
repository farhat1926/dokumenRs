...
export default function Spkrkk() {
  ...
  const units = [
      {
      nama: "Dokter dan Dokter Spesialis",
      kategori: [
        {
        nama: "Dokter dan Dokter Spesialis",
        drive: "https://drive.google.com/drive/folders/1ocUgqKDYTtQbrqHoxfyjY496uugORRnX?usp=drive_link",
        password: "dokterdandokterspesialis",
        },
    ],
    },
      {
      nama: "Perawat dan Bidan",
      kategori: [
        {
          nama: "Perawat dan Bidan",
          drive: "https://drive.google.com/drive/folders/1XFCwCoC4TqiM2B9V9g1Sdi1GRtin26Yl?usp=drive_link",
          password: "perawatdanbidan",
        },
      ],
    },
     {
     ...
     {
      nama: "Tenaga Non Medis",
      kategori: [
        {
          nama: "Tenaga Non Medis",
          drive: "https://drive.google.com/drive/folders/1_fckyfdJ8xJ7pIKXN51961L7Pnjuejim?usp=drive_link",
          password: "tenaganonmedis",
        },
      ],
    },
  ];
